...
const MAXIMOS_INTENTOS = 20, // Intentos máximos que tiene el jugador
    ...
    NOMBRE_IMAGEN_OCULTA = "./memorama/question.png"; // La imagen que se muestra cuando la real está oculta
new Vue({
    el: "#app",
    data: () => ({
        // La ruta de las imágenes. Puede ser relativa o absoluta
        imagenes: [
            "./memorama/ERITROCITO.jpg",
            "./memorama/DACRIOCITO.jpg",
            "./memorama/ACANTOCITO.jpg",
            "./memorama/DREPANOCITO.jpg",
            "./memorama/CODOCITOS.jpg",
            "./memorama/EQUINOCITO.jpg",
        ],
        memorama: [],
    ...
    methods: {
        ...
        indicarFracaso() {
            Swal.fire({
                    title: "Perdiste",
                    html: `
                <img class="img-fluid" src="./memorama/perdiste.png" alt="Perdiste">
        ...
        indicarVictoria() {
            Swal.fire({
                    title: "¡Ganaste!",
                    html: `
                <img class="img-fluid" src="./memorama/ganaste.png" alt="Ganaste">
